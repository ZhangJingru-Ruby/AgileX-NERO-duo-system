...
| --- | --- | --- |
| `lab_world` | `arm_a/world` | `docs/phases/s11_measurement_notes.md` |
| `lab_world` | `arm_b/world` | `docs/phases/s11_measurement_notes.md` |
...
Use the measured values from `docs/phases/s11_measurement_notes.md`.

...
`docs/phases/s11_measurement_notes.md` and `docs/phases/s11_static_tf_plan.md`.
...
`docs/phases/s11_static_tf_plan.md`. The final RViz-valid transform is published to
...
```text
docs/evidence/pics/s11_measurement_20260626/
```
...
Fill `docs/phases/s11_measurement_notes.md`.

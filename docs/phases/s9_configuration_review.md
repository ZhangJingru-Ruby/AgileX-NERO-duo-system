...
| --- | --- | --- | --- |
| 安装位置设置 | `docs/evidence/pics/S9.1/A02.png`, `A04.png`: `1-水平正装` | `docs/evidence/pics/S9.1/B02.png`, `B03.png`: `1-水平正装` | Confirm table-upright corresponds to Web option `1-水平正装`. |
...
Operator screenshots are stored in `docs/evidence/pics/S9.1/`. The file names are not the
recommended names, but the `A*` and `B*` prefixes are treated as operator labels
for Arm A and Arm B.

Arm A Web readout:

- Status/control page: `docs/evidence/pics/S9.1/A02.png`.
- Zero-setting dialog: `docs/evidence/pics/S9.1/A01.png`.
- Joint limit / end-speed page: `docs/evidence/pics/S9.1/A03.png`.
- Collision / load / installation / end-effector page:
  `docs/evidence/pics/S9.1/A04.png`.
- Control mode: `CAN`.
...
- Joint limit / end-speed page: `docs/evidence/pics/S9.1/B01.png`.
- Collision / load / installation / end-effector page:
  `docs/evidence/pics/S9.1/B02.png`.
- Status/control page: `docs/evidence/pics/S9.1/B03.png`.
- Control mode: `CAN`.
- Installation position: `1-水平正装`.
- End effector: `默认（无加载）`.
- Load mode: `满载`.
...
- Complete snapshot path: `docs/evidence/ros_snapshots/20260625_044256/`.
...
- `docs/evidence/pics/s9_arm_a_install_pose.png`
- `docs/evidence/pics/s9_arm_a_end_effector.png`
- `docs/evidence/pics/s9_arm_a_joint_limits.png`
- `docs/evidence/pics/s9_arm_a_tcp_speed.png`
- `docs/evidence/pics/s9_arm_a_collision.png`
- `docs/evidence/pics/s9_arm_a_zero_page.png`
- `docs/evidence/pics/s9_arm_b_install_pose.png`
- `docs/evidence/pics/s9_arm_b_end_effector.png`
- `docs/evidence/pics/s9_arm_b_joint_limits.png`
- `docs/evidence/pics/s9_arm_b_tcp_speed.png`
- `docs/evidence/pics/s9_arm_b_collision.png`
- `docs/evidence/pics/s9_arm_b_zero_page.png`
...
- A ROS read-only snapshot exists under `docs/evidence/ros_snapshots/`.
...
6. Capture after-change screenshot, suggested path:
   `docs/evidence/pics/S9.3/arm_a_load_mode_after.png`.
...
3. Capture after-change screenshot, suggested path:
   `docs/evidence/pics/S9.3/arm_b_load_mode_after.png`.
...
- No after-change load-mode screenshots were found under `docs/evidence/pics/` at review

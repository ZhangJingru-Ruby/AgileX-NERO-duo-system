...
- Post-ROS snapshot: `docs/evidence/ros_snapshots/20260625_064243/`.
...
- Post-ROS snapshot: `docs/evidence/ros_snapshots/20260625_074953/`.

Final control-source audit:

- Saved output: `docs/results/s10_8_control_source_audit_live_20260625_155538.txt`.

...
echo "Starting dual-arm ROS read-only drivers."
echo "Arm A: namespace=$arm_a_ns can_port=$arm_a_can"
echo "Arm B: namespace=$arm_b_ns can_port=$arm_b_can"
echo "Safety: auto_enable=false, control_enabled=false"

cleanup() {
  echo "Stopping dual-arm ROS read-only drivers..."

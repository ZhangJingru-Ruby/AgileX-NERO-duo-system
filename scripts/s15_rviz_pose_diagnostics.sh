...
echo "1) Feedback topic publishers/subscribers:"
...
echo "Interpretation:"
echo "- If feedback topics have no robot_state_publisher subscribers, RViz will show URDF zero pose."
echo "- If lab_world -> arm_*/world is wrong or missing, the accepted S11 root rotation is not active."
echo "- If feedback samples are present but link7 TF stays at zero-pose geometry, inspect robot_state_publisher remapping."

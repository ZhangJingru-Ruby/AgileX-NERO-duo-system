...
echo "Starting S14 dual Revo2 ROS read-only drivers."
echo "Arm A: namespace=$arm_a_ns can_port=$arm_a_can effector_type=revo2"
echo "Arm B: namespace=$arm_b_ns can_port=$arm_b_can effector_type=revo2"
echo "Safety: auto_enable=false, control_enabled=false"
echo "This script does not publish hand or arm control commands."

cleanup() {
  echo "Stopping S14 dual Revo2 ROS read-only drivers..."
